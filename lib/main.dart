...
import 'Menus/GameMenuV2.dart';
import 'Menus/HostMenu.dart';
import 'Menus/LeaderboardMenu.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        "HOST": (BuildContext context) => HostMenu(),
        "GAME_DRAG": (BuildContext context) => DragGame(),
        "GAMES": (BuildContext context) => GameMenuV2(),
        ...
        "LEADERBOARD":(BuildContext context) => LeaderboardMenu(),
      },
    );
  }
}
