        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () async {
                bool? created =
                    await _flutterP2pConnectionPlugin.createGroup(); // button
            ...
            ElevatedButton(
              onPressed: () async {
                bool? removed =
                    await _flutterP2pConnectionPlugin.removeGroup(); //3
            ...
            ElevatedButton(
              onPressed: () async {
                var info =
                    await _flutterP2pConnectionPlugin.groupInfo(); //button
                showDialog(
                  context: context,
                  builder: (context) => Center(
                    child: Dialog(
            ...
            ElevatedButton(
              onPressed: () async {
                bool? discovering =
                    await _flutterP2pConnectionPlugin.discover(); // button 4
                snack("discovering $discovering");
              },
            ...
            ElevatedButton(
              ...
              child: const Text("send File from phone"), //automatic from phone
            ),
            ElevatedButton(
              onPressed: () async {
                sendFile(false);
